...
class BinaryHeap {
    ...
    clear() { this.content.length = 0; } // Added clear method
    siftUp(n) {
...
const Pathfinder = {
    GRID_SIZE: 2.0,
    openHeap: new BinaryHeap(node => node.f),
    openSet: new Map(),
    closedSet: new Set(),
...
const endPos = new Vector3(50, 0, 50);

console.time('Pathfinding Optimized');
...
console.timeEnd('Pathfinding Optimized');
